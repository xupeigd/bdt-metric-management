...
public class MetricJobTrigger {
    ...
    public static void trigger(int jobId,
                               ...
                               String addressList) {
        // load data
        JobInfo jobInfo = MetricJobManagementConfig.getAdminConfig().getJobInfoDao().findById(jobId).orElse(null);
        if (jobInfo == null) {
        ...
        JobGroup group = MetricJobManagementConfig.getAdminConfig().getJobGroupAutoRepo().findById(jobInfo.getJobGroup()).orElse(null);
    ...
    private static void processTrigger(JobGroup group, JobInfo jobInfo, int finalFailRetryCount, TriggerTypeEnum triggerType, int index, int total) {
        ...
        log.debug(">>>>>>>>>>> metric-jobs trigger start, jobId:{}", jobLog.getId());
        ...
        log.debug(">>>>>>>>>>> metric-jobs trigger end, jobId:{}", jobLog.getId());
    }
    ...
    public static ReturnT<String> runExecutor(TriggerParam triggerParam, String address) {
        ...
        try {
            ...
            log.error(">>>>>>>>>>> metric-jobs trigger error, please check if the executor[{}] is running.", address, e);
