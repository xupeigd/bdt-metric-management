...
public class PermissionAmisRestController {
    ...
    public FrameworkResponse<List<PermissionOverviewModel>, Void> listPermissions() {
        return FrameworkResponse.frameworkResponse(PermissionModelAdapter.coverPermissionChains(permissionService.queryAllPermissions(null)),
                null, 0, "success");
    }
    ...
    public FrameworkResponse<PermissionOverviewModel, Void> queryPermission(@PathVariable("permissionId") Integer permissionId) {
        ...
        if (CollectionUtils.isEmpty(permissionVOs)) {
            ...
            return FrameworkResponse.frameworkResponse(PermissionModelAdapter.coverToOverviewModel(permissionVOs.get(0)),
                    null, 0, "success");
        }
    }
    ...
    public FrameworkResponse<PermissionOverviewModel, Void> createPermission(@RequestBody PermissionModel permissionModel) {
        ...
        return FrameworkResponse.frameworkResponse(PermissionModelAdapter.coverToOverviewModel(permissionVO), null, 0, "success");
    }
    ...
    public FrameworkResponse<PermissionOverviewModel, Void> modifyPermission(@PathVariable("permissionId") Integer permissionId,
    ...
    public FrameworkResponse<List<Integer>, Void> deletePermissions(@PathVariable("permissionIds") List<Integer> permissionIds) {
    ...
    public FrameworkResponse<RolePermissionModifyModel, Void> modifyPermissionsByRole(@PathVariable("roleId") Integer roleId,
