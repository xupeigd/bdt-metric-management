$(function () {
    ...
    var jobGroupTable = $("#jobgroup_list").dataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: base_url + "/metric-jobs/jobgroup/pageList",
            type: "post",
            data: function (d) {
                var obj = {};
    ...
    $("#jobgroup_list").on('click', '.opt_del', function () {
        ...
        layer.confirm((I18n.system_ok + I18n.jobgroup_del + '？'), {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + '/metric-jobs/jobgroup/remove',
                data: {"id": id},
                dataType: "json",
    ...
    var addModalValidate = $("#addModal .form").validate({
        ...
        submitHandler: function (form) {
            $.post(base_url + "/metric-jobs/jobgroup/save", $("#addModal .form").serialize(), function (data, status) {
                if (data.code == "200") {
                    $('#addModal').modal('hide');
                    layer.open({
                        title: I18n.system_tips,
    ...
    var updateModalValidate = $("#updateModal .form").validate({
        ...
        submitHandler: function (form) {
            $.post(base_url + "/metric-jobs/jobgroup/update", $("#updateModal .form").serialize(), function (data, status) {
                if (data.code == "200") {
