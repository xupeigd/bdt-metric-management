$(function () {
    ...
    var userListTable = $("#user_list").dataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: base_url + "/metric-jobs/user/pageList",
            type: "post",
            data: function (d) {
                var obj = {};
                ...
                "render": function (data, type, row) {
                    return function () {
                        ...
                        var html = '<p id="' + row.id + '" >' +
                            ...
                            '<button class="btn btn-danger btn-xs delete" type="button">' + I18n.user_opt_remove_permissions + '</button>  ' +
                            '</p>';
    ...
    $("#user_list").on('click', '.delete', function () {
        ...
        layer.confirm(I18n.system_ok + I18n.user_opt_remove_permissions_confirm + '?', {
            icon: 3,
            ...
            $.ajax({
                type: 'POST',
                url: base_url + "/metric-jobs/user/remove",
                data: {
                    "id": id
                },
                dataType: "json",
    ...
    var addModalValidate = $("#addModal .form").validate({
        ...
        submitHandler: function (form) {
            ...
            $.post(base_url + "/metric-jobs/user/add", paramData, function (data, status) {
                if (data.code == "200") {
                    $('#addModal').modal('hide');
    ...
    var updateModalValidate = $("#updateModal .form").validate({
        ...
        submitHandler: function (form) {
            ...
            $.post(base_url + "/metric-jobs/user/update", paramData, function (data, status) {
                if (data.code == "200") {
