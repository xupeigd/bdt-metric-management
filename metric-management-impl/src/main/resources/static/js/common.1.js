$(function () {
    ...
    $("#logoutBtn").click(function () {
        ...
        layer.confirm(I18n.logout_confirm, {
            ...
            layer.close(index);
            $.post(base_url + "/identify/logout/0", {}, function (data, status) {
                if (data.code == "200" || status == "success") {
                    layer.msg(I18n.logout_success);
                    setTimeout(function () {
                        window.location.href = base_url + "/metric-jobs/";
                    }, 500);
                } else {
                    layer.open({
                        title: I18n.system_tips,
    ...
    var updatePwdModalValidate = $("#updatePwdModal .form").validate({
        ...
        submitHandler: function (form) {
            $.post(base_url + "/metric-jobs/user/updatePwd", $("#updatePwdModal .form").serialize(), function (data, status) {
                if (data.code == 200) {
