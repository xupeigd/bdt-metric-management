...
<#macro commonHeader>
    <header class="main-header">
        <a href="${request.contextPath}/" class="logo">
            <span class="logo-mini"><b>MJs</b></span>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            ${I18n.system_welcome} ${Request["MJS_LOGIN_IDENTITY"].username}
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="nav-click <#if pageName == "index">active</#if>"><a
                            href="${request.contextPath}/metric-jobs/"><i
...
<#macro commonFooter >
    <footer class="main-footer">
        Powered by <b>Metric-Jobs</b> ${I18n.admin_version}
